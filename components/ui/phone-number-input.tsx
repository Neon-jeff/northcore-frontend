...
export const PhoneInput = forwardRef<HTMLInputElement, PhoneInputProps>(
  (
    ...
    const inputClasses = cn(
      "flex items-center gap-2 relative bg-transparent transition-colors text-base rounded-lg border border-gray-200 pl-3  lg:h-12 h-10  disabled:opacity-50 disabled:cursor-not-allowed md:text-sm has-[input:focus]:outline-none has-[input:focus]:border-zinc-700 has-[input:focus]:ring-ring [interpolate-size:allow-keywords]",
      ...
      <div className="space-y-1">
        <div className={inputClasses}>
          ...
          <input
            ...
            name="phone"
            className={cn(
              "flex w-full border-none bg-transparent text-base transition-colors placeholder:text-muted-foreground outline-none placeholder:text-xs  py-1 p-0 leading-none md:text-sm [interpolate-size:allow-keywords]",
              className
            )}
            {...props}
          />
