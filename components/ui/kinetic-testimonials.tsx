...
const TestimonialCard: React.FC<TestimonialCardProps> = React.memo(
  ({ testimonial, index, cardClassName = "", avatarClassName = "" }) => {
    ...
    return (
      ...
      >
        <Card
          className={`transition-all border-none shadow-none duration-300 pointer-events-none relative overflow-hidden ${
...
const KineticTestimonial: React.FC<KineticTestimonialProps> = ({
  ...
  return (
    <section className={` transition-colors duration-300 ${className}`}>
      <div className="relative w-full text-gray-900 bg-white py-8 md:py-20 flex flex-col items-center overflow-hidden px-4 md:px-6">
