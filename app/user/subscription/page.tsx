...
const SubScriptionPage = () => {
  ...
  return (
    <div className='lg:w-11/12 w-full py-10 p-2 space-y-5 lg:min-h-5/6 max-md:min-h-screen rounded-2xl bg-white lg:p-10 '>
        <h1 className='text-2xl font-bold text-black'>{t('components.yourSubscriptions')}</h1>
        <p className='text-sm text-gray-600'>{t('components.manageYourExpertSubscriptions')}</p>
